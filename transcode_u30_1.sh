...
-map '[a]' -b:v 2.5M -c:v mpsoc_vcu_h264 -c:a acc -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_u30_720p30.mp4 \
-map '[b]' -b:v 4M -c:v mpsoc_vcu_h264 -c:a acc -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_u30_1080p30.mp4 \
-map '[c]' -b:v 8M -c:v mpsoc_vcu_h264 -c:a acc -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_u30_1440p30.mp4 \
-map '[d]' -b:v 10M -c:v mpsoc_vcu_h264 -c:a acc -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_u30_4k30.mp4"
